...
declare class AthomAppsAPI {
     ...
     * @protected
     */
    protected getHighlightedAppsV2(opts?: {
        platform?: string[];
        language?: string;
        tags?: string[];
    }): Promise<object>;
     ...
     * @protected
     */
    protected getAllLiveAppIDs(opts?: any): Promise<object[]>;
    /**
     *
     * @param {object} [opts] - Named parameters
     * @returns { Promise<object[]> } Success
     ...
     * @protected
     */
    protected getAppChangelog(opts?: {
        appId: string;
    }): Promise<void>;
    /**
     *
     ...
     * @protected
     */
    protected getAppDriversStats(opts?: {
        appId: string;
    }): Promise<object>;
    /**
     *
...
declare class AthomCloudAPI {
     ...
     * @protected
     */
    protected addHomeyLicense(opts?: {
        homeyId: string;
        license: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected getAppDriversStatistics(opts?: any): Promise<object>;
    /**
     *
     * <p>
     * <b>Required OAuth scopes:</b><br/>
...
declare class AthomStoreAPI {
     ...
     * @protected
     */
    protected deferSubscription(opts?: {
        sku: string;
        packageName?: string;
        athomId: string;
        quantity: number;
     ...
     * @protected
     */
    protected createOfferCouponApple(opts?: {
        secret: string;
        coupon: string;
        expiresAt: string;
     ...
     * @protected
     */
    protected getOffers(opts?: any): Promise<void>;
    /**
